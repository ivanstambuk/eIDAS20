...
- **AS-WP-09-010–AS-WP-09-017** (Topic 9): Wallet Unit Attestation key binding
- **AS-WP-06-001–AS-WP-06-011** (Topic 6): Relying Party authentication and user approval
...
|---------------|------------------------|-------------|
| **Personalised Security Credentials (PSC)** | All SCA Elements | Per [PSD2 Art. 4(31)](https://eur-lex.europa.eu/legal-content/EN/TXT/HTML/?uri=CELEX:32015L2366#004.031), PSCs are "personalised features provided by the PSP for authentication." In EUDIW, this encompasses **all three SCA element types**: (1) **PIN/Passphrase** (knowledge), (2) **Biometric template** (inherence), and (3) **SCA Attestation + Private Key** (possession). The PIN/biometric unlocks access to the private key, and together they enable generation of the authentication code. |
| **Authentication Code** | VP Token (KB-JWT signature) | [RTS Recital (4)](https://eur-lex.europa.eu/legal-content/EN/TXT/HTML/?uri=CELEX:32018R0389#rct_4) defines this as "digital signatures or other cryptographically underpinned validity assertions." In EUDIW, this is the signed VP Token containing the KB-JWT with `transaction_data_hashes` |
...
| **PIN** | User PIN / Passphrase | **PSC (Knowledge element)** — validated locally by WSCA/WSCD (never transmitted). Protected per [RTS Art. 6](https://eur-lex.europa.eu/legal-content/EN/TXT/HTML/?uri=CELEX:32018R0389#art_6) & [Art. 22](https://eur-lex.europa.eu/legal-content/EN/TXT/HTML/?uri=CELEX:32018R0389#art_22). |
| **Biometric** | OS Biometric (Face ID / BiometricPrompt) | **PSC (Inherence element)** — validated by OS secure biometric API with liveness detection. Protected per [RTS Art. 8](https://eur-lex.europa.eu/legal-content/EN/TXT/HTML/?uri=CELEX:32018R0389#art_8) & [Art. 22](https://eur-lex.europa.eu/legal-content/EN/TXT/HTML/?uri=CELEX:32018R0389#art_22). |
...
| Fulfillment | Reference | Implementation |
|-------------|-----------|----------------|
| ✅ **Wallet** | [AS-WP-09-010](https://github.com/eu-digital-identity-wallet/eudi-doc-architecture-and-reference-framework/blob/main/docs/annexes/annex-2/annex-2.02-high-level-requirements-by-topic.md#a236-topic-9---wallet-unit-attestation) | Private key non-extractable from WSCA/WSCD |
...
#### ARF High-Level Requirement: AS-WP-09-010
...
| Fulfillment | Reference | Implementation |
|-------------|-----------|----------------|
| ✅ **Wallet** | [AS-WP-09-010](https://github.com/eu-digital-identity-wallet/eudi-doc-architecture-and-reference-framework/blob/main/docs/annexes/annex-2/annex-2.02-high-level-requirements-by-topic.md#a236-topic-9---wallet-unit-attestation) | Key pair generated within WSCA/WSCD |
...
| Fulfillment | Reference | Implementation |
|-------------|-----------|----------------|
| ✅ **Wallet** | [EW-DM-38-007](https://github.com/eu-digital-identity-wallet/eudi-doc-architecture-and-reference-framework/blob/main/docs/annexes/annex-2/annex-2.02-high-level-requirements-by-topic.md#a2322-topic-38---wallet-unit-revocation) | Wallet Provider can revoke Wallet Unit |
...
| ✅ **Wallet** | [AS-WP-09-010](https://github.com/eu-digital-identity-wallet/eudi-doc-architecture-and-reference-framework/blob/main/docs/annexes/annex-2/annex-2.02-high-level-requirements-by-topic.md#a236-topic-9---wallet-unit-attestation) | Private key in WSCA/WSCD = possession element |
...
| Fulfillment | Reference | Implementation |
|-------------|-----------|----------------|
| ✅ **Wallet** | [AS-WP-09-017](https://github.com/eu-digital-identity-wallet/eudi-doc-architecture-and-reference-framework/blob/main/docs/annexes/annex-2/annex-2.02-high-level-requirements-by-topic.md#a236-topic-9---wallet-unit-attestation) | WU can prove possession of private key |
...
| ✅ **Wallet** | [EW-DM-38-007](https://github.com/eu-digital-identity-wallet/eudi-doc-architecture-and-reference-framework/blob/main/docs/annexes/annex-2/annex-2.02-high-level-requirements-by-topic.md#a2322-topic-38---wallet-unit-revocation) | Wallet Provider can revoke compromised WUA |
...
| **Device loss** | Uncontrolled key access | Remote revocation via WUA invalidation | ✅ EW-DM-38-007 |
...
| ✅ **Wallet** | [EW-DM-38-007](https://github.com/eu-digital-identity-wallet/eudi-doc-architecture-and-reference-framework/blob/main/docs/annexes/annex-2/annex-2.02-high-level-requirements-by-topic.md#a2322-topic-38---wallet-unit-revocation) | (c) Key revocation if compromise detected |
